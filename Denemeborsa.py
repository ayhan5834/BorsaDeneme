...
# ==============================================================================
# 2. MOBİL UYUMLU VERİ GİRİŞ PANELİ (HTML İLE GÜÇLENDİRİLDİ)
# ==============================================================================
def mobil_veri_giris_formu(db):
    st.markdown("""
        <form method="get" style="background:#1E1E1E; padding:15px; border-radius:10px; border:1px solid #2D2D2D;">
            <input type="text" name="kod" placeholder="Hisse Kodu (Örn: THYAO)" style="width:100%; padding:10px; margin-bottom:10px; border-radius:5px; border:none;">
            <input type="number" name="maliyet" placeholder="Maliyet" step="0.01" style="width:100%; padding:10px; margin-bottom:10px; border-radius:5px; border:none;">
            <input type="number" name="adet" placeholder="Adet" style="width:100%; padding:10px; margin-bottom:10px; border-radius:5px; border:none;">
            <button type="submit" style="width:100%; padding:10px; background:#00F0FF; border:none; border-radius:5px; font-weight:bold;">KAYDET</button>
        </form>
...
# ==============================================================================
# 3. ANA UYGULAMA (KODUNUN GERİ KALANINI BOZMADAN)
# ==============================================================================
if IS_STREAMLIT:
    ...
    with sekme1:
        ...
        mobil_veri_giris_formu(db) # Veri girişini buraya sabitledik
